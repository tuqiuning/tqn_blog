    ...
    "zh-CN": [
        {
            ...
            overview: '本项目是一个综合性平台，旨在为女性提供全品类的健康服务和产品。平台集结了女性用户、到家健康师和女性健康门店，将线下消费场景与线上平台有机结合。该平台共有三个端，分别为用户端、商家端和管理端。',
            skills: ['uniapp','uView','Element-UI'],
            content: [
                '开发用户端购买项目和商品的全流程，包括领取优惠券、收藏、加入购物车、拼团、下单、服务预约、商品物流地图查询、到店项目核销、评价。',
                '开发用户端热门活动，包括抽奖、签到、秒杀、许愿墙、砸金蛋等功能。',
                '开发用户端分享功能，使用户可以将项目、商品和门店分享给好友，好友下单后赚取佣金。',
                '开发商家端健康师和门店入驻流程，包括填写资料、签署协议、缴费以及选择服务时间和服务区域。',
                '商家端健康师和门店的项目、优惠券、秒杀项目的增删改查。',
                '负责项目的微信小程序和抖音小程序的提审和发布以及H5的打包和部署工作。'
            ]
        },
        {
            name: '中信集团协同+',
